...
import {NgSimpleProgressBarComponent, ProgressBarType} from './ng-simple-progress-bar.component';
...
describe('NgSimpleProgressBarComponent', () => {
    ...
    it('should not emit percentChange event if static', () => {
        ...
        const service = fixture.debugElement.injector.get(NgSimpleProgressBarService);
        spyOn(service, 'startProgress').and.callFake(() => service.progressEvent.next(new ProgressBarEvent(updatedPercent)));
